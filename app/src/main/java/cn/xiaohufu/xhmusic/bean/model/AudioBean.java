package cn.xiaohufu.xhmusic.bean.model;
...
import cn.xiaohufu.xhmusic.bean.DailyRecommendBean;
import cn.xiaohufu.xhmusic.bean.SongDetailBean;
...
public class AudioBean {
    ...
    public static AudioBean convertSongToAudioBean(SongDetailBean.SongsBean item) {
        return new AudioBean(String.valueOf(item.getId())
                , getSongPlayUrl(item.getId())
                , item.getName()
                ...
                , new SimpleDateFormat(
                        "mm:ss",
                         Locale.getDefault()).format(item.getDt()));
    }
